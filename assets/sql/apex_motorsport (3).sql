...
INSERT INTO `reviews` (`id`, `title`, `car_name`, `review`, `path`, `alt_text`, `created_at`, `updated_at`) VALUES
(12, 'Review', 'Ferrari', 'this is some text', 'reviews/1733244951-Wall_inspiration__1_.jpeg', NULL, '2024-12-03 16:55:51', '2024-12-03 16:55:51'),
(34, 'Car Title', 'ferrari 488', 'some text for the review', 'reviews/1733835277-ferrari-458-speciale_front.jpg', '', '2024-12-09 17:26:25', '2024-12-10 12:54:37'),
(35, 'Honda NSS', 'Ferrari', 'some text', 'reviews/1733937674-_ (6).jpeg', '', '2024-12-09 17:26:25', '2024-12-11 17:21:14'),
(36, 'Porsche ', 'Porsche 911 Turbo S', 'Porsche 911 Turbo S', 'reviews/1733835308-porsche_config2.jpeg', 'Porsche 911 Turbo S', '2024-12-09 17:27:05', '2024-12-10 12:55:08'),
(38, 'Porsche New', 'New Review', 'Hello World', 'reviews/1733835399-prosche-config.webp', '', '2024-12-10 12:56:39', '2024-12-10 12:56:39');
...
(9, '../assets/uploads/folder_1/1732226166-viber_image_2024-10-06_19-04-51-254.jpg', 'this is second attempt'),
(10, '../assets/uploads/folder_1/1732226167-viber_image_2024-10-06_19-04-51-254.jpg', 'this is second attempt'),
(11, '../assets/uploads/folder_1/1732275863-viber_image_2024-10-06_19-04-51-254.jpg', 'Wallpaper'),
(12, '../assets/uploads/folder_3/1732308555-viber_image_2024-10-06_19-04-51-254.jpg', 'Wallpaper'),
(13, '../assets/uploads/folder_1/1733223639-Wall inspiration (1).webp', ''),
(14, '../assets/uploads/folder_1/1733223648-Wall inspiration (1).webp', '');
...
CREATE TABLE `users` (
  ...
  `country` varchar(50) NOT NULL,
  `comment` text,
  `title` enum('male','female') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
