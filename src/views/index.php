...
<body>
    ...
    <!-- porsche racetrack background image -->
    ...
    <section class="quote-section">
        <p class="quote">"Cars are the sculptures of our everyday lives."</p>
        <small class="bangle-role">Chris Bangle former chief designer at BMW</small>
    </section>

    <!-- discover section -->
    <div class="accordion discover-section">
        <div class="accordion-item model-section">
